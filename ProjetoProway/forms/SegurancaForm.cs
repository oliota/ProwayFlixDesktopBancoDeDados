...
{
    public partial class SegurancaForm : Form
    {
        ...
        private void SegurancaForm_Load(object sender, EventArgs e)
        {
        ...
        {
            tabLogin.SelectTab(0);
            tbLogin.Text = string.Empty;
            tbSenha.Text = string.Empty;
            tbCadastroNome.Text = string.Empty;
            tbCadastroEmail.Text = string.Empty;
            tbCadastroLogin.Text = string.Empty;
            tbCadastroSenha.Text = string.Empty;
            tbCadastroSenha2.Text = string.Empty;
        }
